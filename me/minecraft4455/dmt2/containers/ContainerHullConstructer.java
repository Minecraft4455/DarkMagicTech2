package mods.me.minecraft4455.dmt2.containers;

import mods.me.minecraft4455.dmt2.DarkMagicTech2;
import mods.me.minecraft4455.dmt2.handler.CraftingManagerHullConstructer;
...
public class ContainerHullConstructer extends Container {
 ...
 public InventoryCrafting craftMatrix = new InventoryCrafting(this, 1, 5);
    ...
    public static int InputSlotNumber = 5; //Number of Slots in the Crafting Grid
    ...
    public ContainerHullConstructer(InventoryPlayer inventory, TileHullConstructer tile){
      ...
      this.tile_entity = tile;
            ...
            for (var6 = 0; var6 < 1; ++var6)
            {
                ...
                {
                    this.addSlotToContainer(new Slot(this.craftMatrix, var7 + var6 * 1, 50 + var7 * 30, 20 + var6 * 35));
                }
                //Top Slot
                for (var7 = 1; var7 < 2; ++var7)
                {
                    this.addSlotToContainer(new Slot(this.craftMatrix, var7 + var6 * 1, 50 + var7 * 0, 40 + var6 * 60));
                }
                //Left Slot
                for (var7 = 2; var7 < 3; ++var7)
                {
                    this.addSlotToContainer(new Slot(this.craftMatrix, var7 + var6 * 1, 100 + var7 * -10, 45 + var6 * 60));
                }
                //Right Slot
                for (var7 = 3; var7 < 4; ++var7)
                {
                    this.addSlotToContainer(new Slot(this.craftMatrix, var7 + var6 * 1, 50 + var7 * -10, 50 + var6 * 60));
                }
                //Bottom Slot
                for (var7 = 4; var7 < 5; ++var7)
                {
                    this.addSlotToContainer(new Slot(this.craftMatrix, var7 + var6 * 1, 50 + var7 * -10, 4555 + var6 * 60));
                }
            }
  ...
  public boolean canInteractWith(EntityPlayer par1EntityPlayer){
   if (worldObj.getBlockId(posX, posY, posZ) != DarkMagicTech2.HullConstructer.blockID){
    return false;
   }
