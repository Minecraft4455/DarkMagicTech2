...
import mods.me.minecraft4455.dmt2.handler.CraftingManagerWriter;
    ...
    public ContainerWriter(InventoryPlayer inventory, TileWriter tile){
      ...
      this.tile_entity = tile;
            ...
            for (var6 = 0; var6 < 1; ++var6)
            {
                ...
                {
                    this.addSlotToContainer(new Slot(this.craftMatrix, var7 + var6 * 1, 50 + var7 * 30, 35 + var6 * 35));
                }
                for (var7 = 1; var7 < 2; ++var7)
                {
                    this.addSlotToContainer(new Slot(this.craftMatrix, var7 + var6 * 1, 50 + var7 * 0, 55 + var6 * 60));
                }
                for (var7 = 2; var7 < 3; ++var7)
                {
                    this.addSlotToContainer(new Slot(this.craftMatrix, var7 + var6 * 1, 50 + var7 * -10, 45 + var6 * 60));
                }
            }
